...
fn main() {
    ...
    let result = life_support(&input, 12);

    println!("Part 2: {}", result);
}

fn life_support(data: &Vec<String>, size: i32) -> i32 {
...
fn highest_usage(data: &Vec<String>, size: i32, bit_pos: i32) -> String {
...
mod tests {
    ...
    fn test() {
        ...
        assert_eq!(power(&life_support, 5), 230);
    }
}